...
export const Footer = () => {
    return (
        <div className="w-screen bg-[var(--background-color)] text-white text-sm flex flex-row justify-between items-center pb-6 px-8 select-none">
            
            <div className="flex">
                <p>© Aurora Toscano</p>
                <p className="px-2">•</p>
                <p>Developed by <span className="font-bold hover:text-[var(--accent-purple)] cursor-pointer transition delay-100 duration-150 ease-in-out"><a href="albieguerriero.com">Albie G.</a></span></p>
            </div>

            <div className="flex flex-row gap-3">

                <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/aurora-toscano-b26671232/">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-6 text-white hover:text-[var(--accent-purple)] cursor-pointer transition delay-100 duration-150 ease-in-out">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/auureta/?hl=en">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-6 text-white hover:text-[var(--accent-purple)] cursor-pointer transition delay-100 duration-150 ease-in-out">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier"> 
